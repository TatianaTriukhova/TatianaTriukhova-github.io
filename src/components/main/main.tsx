  ...
  return (
    <div className="mainContainer">
      ...
      <div className="introSection">
        ...
        <p>
          Software engineer always open to opportunities to push my boundaries
